...
int main()
{
    ...
    /* Create the tasks. */
    led_data_q = xQueueCreate(1,sizeof(struct LED_Data));
    xTaskCreate(LED_Task, "LED task", configMINIMAL_STACK_SIZE*2, NULL, configMAX_PRIORITIES-1, NULL);
    xTaskCreate(game_controller_task, "Game Controller task", configMINIMAL_STACK_SIZE*8, NULL, configMAX_PRIORITIES-3, NULL);
